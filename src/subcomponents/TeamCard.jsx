...
function TeamCard({ key, name, type, contact_no, email, insta_id, linkedin, source_url }) {
                ...
                <div className='member-links'>
                    ...
                    >
                        <span style={{ display: (contact_no === "#") ? "none" : "inline-block" }}>
                            <IconButton>
                                <CallIcon className="text-sm text-primary" />
                            </IconButton>
                        </span>
                    </motion.a>
                    <motion.a
                    ...
                    >
                        <span style={{ display: (email === "#") ? "none" : "inline-block" }}>
                            <IconButton>
                                <AlternateEmailIcon className="text-sm text-primary" />
                            </IconButton>
                        </span>
                    </motion.a>
                    <motion.a
                    ...
                    >
                        <span style={{ display: (insta_id === "#") ? "none" : "inline-block" }}>
                            <IconButton>
                                <InstagramIcon className="text-sm text-primary" />
                            </IconButton>
                        </span>
                    </motion.a>
                    <motion.a
                    ...
                    >
                        <span style={{ display: (linkedin === "#") ? "none" : "inline-block" }}>
                            <IconButton>
                                <LinkedInIcon className="text-sm text-primary" />
                            </IconButton>
                        </span>
                    </motion.a>
                </div>
